...
export default class Navbar extends React.Component {
  ...
  render() {
    return (
      <nav className="flex md:flex-row flex-col w-full items-center border-b bg-gray-50 border-gray-300 shadow-sm p-1 md:p-2 mb-6 md:mb-4">
        ...
        >
          <div className="md:inline-flex md:flex-row md:ml-auto md:w-auto w-full md:items-center items-start flex flex-col md:h-auto border-t border-gray-300 mt-1 pt-1 md:border-0 md:whitespace-pre transition">
            <Link href="/portfolio">
              <a className="md:inline-flex md:w-auto w-full px-3 py-2 rounded font-bold items-center justify-center hover:bg-blue-600 hover:text-white transition duration-100">
                Portfolio
              </a>
            </Link>
            <Link href="/report">
            ...
            <Link href="/api/auth/signout">
              <a className="md:inline-flex md:w-auto w-full px-3 py-2 rounded font-bold items-center justify-center hover:bg-red-600 hover:text-white border-t border-gray-100 md:border-0 transition duration-100">
                Sign Out
              </a>
            </Link>
          </div>
